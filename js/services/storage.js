...
(function (global) {
  ...
  function write(key, value) {
    ...
    const syncKeys = [KEYS.items, KEYS.vehicles, KEYS.services, KEYS.routes, KEYS.cities, KEYS.users, KEYS.settings];
    if (syncKeys.indexOf(key) >= 0 && global.GithubSync && GithubSync.schedulePush) {
